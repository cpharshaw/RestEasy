    ...
    return (
      ...
      {console.log(this.props)}
        ...
        <div className="back text-center p-4">
          ...
          <Link className="home-button nav-item nav-link" to='#'><button type="button" className="btn btn-secondary font-weight-bold text-body btn-lg btn-block">About Us</button></Link>
